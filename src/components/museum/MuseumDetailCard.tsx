            ...
            <GlassPanel intensity="heavy" className="mb-8 relative overflow-hidden group border-0 sm:border !rounded-none sm:!rounded-3xl">
                ...
                <div className="relative h-56 sm:h-72 w-full overflow-hidden bg-gray-900">
                    ...
                    <button
                        ...
                        className={`absolute top-4 right-4 w-11 h-11 rounded-full flex items-center justify-center shadow-lg backdrop-blur-md transition-all active:scale-95 cursor-pointer z-10 ${isPicked ? 'bg-purple-500 border border-purple-200 text-white' : 'bg-black/40 border border-white/30 text-white hover:bg-black/60 hover:border-white/60'}`}
                    >
                        <svg className={`w-5 h-5 transition-transform ${isPicked ? 'scale-110 drop-shadow-sm' : 'scale-100 opacity-90'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={isPicked ? 3 : 2}>
