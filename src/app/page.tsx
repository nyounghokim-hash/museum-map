...
export default function MainPage() {
  ...
  return (
    <div className="relative w-full h-[calc(100vh-3.5rem-100px)] lg:h-[calc(100vh-3.5rem)] flex overflow-hidden">
      ...
      <div className="relative flex-1 transition-all duration-300">
        ...
        {!isViewingActiveRoute && !aiOpen && (
          <div className="absolute bottom-6 lg:bottom-4 right-4 z-10">
            <button
