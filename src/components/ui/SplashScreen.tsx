...
const SUBTITLES: Record<string, string> = {
    ...
    ja: '世界の美術館を巡ろう',
    zh: '探索全球博物馆',
    de: 'Museen weltweit entdecken',
    fr: 'Explorez les musées',
    es: 'Explora museos del mundo',
    pt: 'Explore museus do mundo',
    sv: 'Utforska museer världen',
    fi: 'Tutustu maailman museoihin',
    da: 'Udforsk museer verden over',
    et: 'Avasta maailma muuseumid',
};
